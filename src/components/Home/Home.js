        ...
        <div className="contain">
            ...
            >
                <div className="text">
                    ...
                    <blockquote>
                        <p>
                            “ Ce site recense quelques projets personnels que j'ai entreppris seul et avec d'autres developpeurs , je vous invite à les parcourir sur la page "projets" et à me faire vos retours si vous le souhaitez . ”
                </p>
                    </blockquote>
                </div>
            </ScrollAnimation>
