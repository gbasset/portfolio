        ...
        <div className="contain">
            ...
            >
                <div className="text">
                    ...
                    <blockquote>
                        <p>
                            “ Ce site recense quelques projets personnels que j'ai entreppris seul mais également avec d'autres developpeurs.Je vous invite donc à les parcourir sur la page "projets" et à me faire vos retours si vous le souhaitez . ”
                </p>
                    </blockquote>
                </div>
            </ScrollAnimation>
